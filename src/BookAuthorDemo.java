...
public class BookAuthorDemo {
    public static void main(String[] args) {
        ...
        System.out.println("All Book Records: " + bookAuthors);

        System.out.println("Author of '1984': " + bookAuthors.get("1984"));
        System.out.println("Is 'The Hobbit' in the list? " + bookAuthors.containsKey("The Hobbit"));

        bookAuthors.put("1984", "Orwell (Updated)");
        System.out.println("Updated Records: " + bookAuthors);

        bookAuthors.remove("Hamlet");
        System.out.println("Records after removing Hamlet: " + bookAuthors);
